...
Add "jmform" to your plugins control and "jmformcontrols" in the theme_advanced_buttons control (or wherever you indicate what buttons).
...
You can optionally insert each icon individually. To do this replace "jmformcontrols" in the buttons control with one or more of the following:
    ...
    "jmform,jmform_insert_input,jmform_insert_select,jmform_insert_textarea,delete_jmform"
