...
function init() {
    ...
    var onfocus = '', onblur = '', onchange = '', onselect = '', onclick = '', onkeyup = '', onkeydown = '';
    ...
    if (textElm != undefined) {
    	...
    	jmformValue = '';
    	if (textElm.value != undefined) jmformValue = textElm.value;
    	...
    	onkeyup = tinyMCE.getAttrib(textElm, 'onkeyup');
    	onkeydown = tinyMCE.getAttrib(textElm, 'onkeydown');
